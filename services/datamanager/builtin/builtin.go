...
func (svc *builtIn) Reconfigure(
	...
	svc.additionalSyncPaths = append(svc.additionalSyncPaths, svc.captureManager.CaptureDir())
	svc.additionalSyncPaths = append(svc.additionalSyncPaths, svcConfig.AdditionalSyncPaths...)
